\documentclass[oneside, doctor]{NJUPT-Dissertation-grd}
%oneside选项表示单页打印,twoside选项表示双页打印. 默认单面 oneside。
%建议最终论文打印时采用双页打印

%博士选择NJUPT-Dissertation-grd，博士盲审将NJUPT-Dissertation-grd替换为NJUPT-Dissertation-grd_Blind
...
\thispagestyle{NJUPT@headings}
\pagestyle{NJUPT@headings}
\listoftables
